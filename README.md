...
Welcome to the official repository for the **EPC Solar Engine** - a next-generation PV Module Multi-Criteria Decision Analysis (MCDA) and Executive Financial Optimizer.

## 🚀 Alpha Demo Available Now
We have released a mathematically-limited, sandboxed **Alpha Demo** for public testing and portfolio demonstration. The demo allows users to experience the speed and utility of the engine's core capabilities.

### Demo Limitations
To protect proprietary algorithms and extensive dataset licensing, the Alpha Demo is restricted:
...
## 🔒 Full-Fledged Premium Features (Private Repository)
...
* **Massive PV Database:** Predicate pushdown querying across 21,000+ solar modules.
